...
| 9 | — | openttd/ (vendorováno) | x64 | | ověření vendorovaného zdroje + prvního refaktoringu (`TryConsistSplice` extrakce z `CmdMoveRailVehicle`, beze změny chování) po opravě pandoc kroku |
