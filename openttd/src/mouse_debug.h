 ...
 *
 * Long enough to hold the beginning of the fault as well as the noticing of
 * it: a map that has started dragging itself takes a while to be spotted,
 * and five seconds regularly kept only the tail of it. */
static constexpr int MOUSE_DEBUG_KEEP_MS = 20000;
