...
enum class ViewportScrollMode : uint8_t {
	RMBPinned, ///< Right mouse button; the pointer stays where it was pressed and the game never moves it itself.
...
struct VehicleSettings {
	...
	uint8_t train_braking; ///< "brake, fail to brake and crash" and how far the driver sees: 0 = off, the driver sees as far as braking needs; 1 = on, the same sight; 2..5 = on, 5, 10, 15, 20 tiles
	...
	bool no_engine_cargo; ///< engines may not carry cargo -- wagons haul, engines pull
	...
	bool engine_care; ///< engines are looked after properly: they never grow more prone to breaking down than they were when new, and upkeep costs a fifth more
