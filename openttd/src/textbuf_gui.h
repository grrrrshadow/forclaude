...
void ShowQueryStringWithChoice(std::string_view str, StringID caption, uint max_len, Window *parent, CharSetFilter afilter, QueryStringFlags flags, StringID top_button, StringID bottom_button, uint8_t choice, StringID tooltip, StringID top2_button = INVALID_STRING_ID, bool toggle2 = false);
